...
def fun1(t,z):
    b=np.zeros((3*M,1))
    b[0]=-0.04*z[0]+(10**4)*z[1]*z[2]
    b[1]=0.04*z[0]-(10**4)*z[1]*z[2]-3*(10**7)*(z[1]**2)
    b[2]=3*(10**7)*(z[1]**2)
...
widetwoRKCv2 = np.load(r'C:\Users\A204-7\Desktop\RKC\RKC\widetwostepRKCv6.npz', allow_pickle=True)
cs = widetwoRKCv2['cs']
...
#plt.legend()
  print("h:",h)
  solu1=np.load('ROBERsolut_end10v1.npy')
