...
def fun1(t,z):
    b=np.zeros((8*M,1))
    b[0]=-1.71*z[0]+0.43*z[1]+8.32*z[2]+0.0007
    b[1]=1.71*z[0]-8.75*z[1]
    b[2]=-10.03*z[2]+0.43*z[3]+0.035*z[4]
    b[3]=8.32*z[1]+1.71*z[2]-1.12*z[3]
    b[4]=-1.745*z[4]+0.43*z[5]+0.43*z[6]
    b[5]=-280*z[5]*z[7]+0.69*z[3]+1.71*z[4]-0.43*z[5]+0.69*z[6]
    b[6]=280*z[5]*z[7]-1.81*z[6]
    b[7]=-280*z[5]*z[7]+1.81*z[6]
...
df = pd.DataFrame({'HIRESsolut_end321v1': Robsolu})
df1 = pd.DataFrame({'HIRESsolut_end321v2': Robsolu1})

np.save('HIERSsolut_end321v1.npy',Robsolu)
np.save('HIERSsolut_end321v2.npy',Robsolu1)
