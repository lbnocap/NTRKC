...
df = pd.DataFrame({'NTRKCBURGERyt0.1solu_0.00001v1': Robsolu})
df1 = pd.DataFrame({'NTRKCBURGERyt0.1solu_0.00001v2': Robsolu1})

# 保存到新的 Excel 文件

#df.to_excel("SERKv2ROBsolu.xlsx", index=False)
np.save('NTRKCBURGERyt0.1solu_0.00001v1.npy',Robsolu)
np.save('NTRKCBURGERsyt0.1olu_0.00001v2.npy',Robsolu1)